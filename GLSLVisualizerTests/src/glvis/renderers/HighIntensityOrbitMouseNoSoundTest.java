 ...
 * @author root
 */
public class HighIntensityOrbitMouseNoSoundTest extends VisRender {

    public HighIntensityOrbitMouseNoSoundTest(AudioProvider provider, int shader) {
        super(provider, shader);
        for(int i = 0; i < 4096; i++){
            loc_x[i] = (float) (Math.random()*1280-(1280/2));
            loc_y[i] = (float) (Math.random()*720-(720/2));
        }
...
//        int LIGHT_POINTS = 1152; // 1152
        ...
        }else GL11.glColor4f(0f,0f,0f,0.06f);
...
//            LIGHT_Y = loc_y[ie]*4+720/2;
            ...
            GL20.glUniform3f(GL20.glGetUniformLocation(this.shaderProgram, (CharSequence) "colour"), R[ie]/4, G[ie]/4, B[ie]/4);
            GL11.glEnable(3042);
