 ...
 * @author root
 */
public class HighIntensityAccurate extends VisRender{

    public HighIntensityAccurate(AudioProvider provider, int shader) {
...
//        int LIGHT_POINTS = 1152; // 1152
        ...
        }else GL11.glColor4f(0f,0f,0f,0.4f);
...
//            LIGHT_Y = loc_y[ie]*4+720/2;
            ...
            GL20.glUniform3f(GL20.glGetUniformLocation(this.shaderProgram, (CharSequence) "colour"), R[ie]/5, G[ie]/5, B[ie]/5);
            GL11.glEnable(3042);
