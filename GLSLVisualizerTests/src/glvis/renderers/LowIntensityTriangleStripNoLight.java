 ...
 * @author root
 */
public class LowIntensityTriangleStripNoLight extends VisRender{

    public LowIntensityTriangleStripNoLight(AudioProvider provider, int shader) {
...
//        int LIGHT_POINTS = 1152; // 1152
        ...
        }else GL11.glColor4f(0f,0f,0f,0.05f);
