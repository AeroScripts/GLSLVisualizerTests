 ...
 * @author root
 */
public class HighIntensityOrbitMouseNoSoundTestGlitch extends VisRender {

    public HighIntensityOrbitMouseNoSoundTestGlitch(AudioProvider provider, int shader) {
